...
#写入数据
curl -XPOST http://localhost:9200/jd/data/1 -d'
{
...
#查看刚才写入的id=1的数据
curl -XGET http://localhost:9200/jd/data/1 | jshon
...
#重复写入新数据
curl -XPOST http://localhost:9200/jd/data/2 -d'
{
    "id":2,
    "cateid":101,
    "tag":"手机",
...
curl -XPOST http://localhost:9200/jd/data/3 -d'
{
    "id":3,
    "cateid":101,
    "tag":"手机",
...
curl -XPOST http://localhost:9200/jd/data/4 -d'
{
    "id":4,
    "cateid":102,
    "tag":"电脑",
